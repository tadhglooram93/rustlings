...
// Updated signature to use Box<dyn Error> which can represent any error type.
// This allows `main` to return different error types encapsulated as a trait object.
